...
#include "../../test_customButton/custompixmapbutton.h"
...
QT_MOC_LITERAL(3, 31, 2) // "id"
    ...
    "CustomPixmapButton\0sig_choose\0\0id"
};
...
const QMetaObject CustomPixmapButton::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CustomPixmapButton.data,
...
void *CustomPixmapButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsPixmapItem"))
        return static_cast< QGraphicsPixmapItem*>(const_cast< CustomPixmapButton*>(this));
