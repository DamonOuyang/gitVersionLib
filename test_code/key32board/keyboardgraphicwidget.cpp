#include "keyboardgraphicwidget.h"

keyBoardGraphicWidget::keyBoardGraphicWidget(QGraphicsWidget *parent) :
...
keyBoardGraphicWidget::~keyBoardGraphicWidget()
{

}

void keyBoardGraphicWidget::changeEvent(QEvent *e)
{
...
bool keyBoardGraphicWidget::eventFilter(QObject *obj, QEvent *event)
{
...
//***********************按键*****************************//
void keyBoardGraphicWidget::on_num1Button_clicked()       //1
{
...
void keyBoardGraphicWidget::on_num2Button_clicked()       //2
{
...
void keyBoardGraphicWidget::on_num3Button_clicked()       //3
{
    int idx = lineEdit->cursorPosition();
    if(strContent.left(idx) == "0")
    {
...
void keyBoardGraphicWidget::on_num4Button_clicked()       //4
{
    int idx = lineEdit->cursorPosition();
    if(strContent.left(idx) == "0")
    {
...
void keyBoardGraphicWidget::on_num5Button_clicked()       //5
{
    int idx = lineEdit->cursorPosition();
    if(strContent.left(idx) == "0")
    {
...
void keyBoardGraphicWidget::on_num6Button_clicked()       //6
{
    int idx = lineEdit->cursorPosition();
    if(strContent.left(idx) == "0")
    {
...
void keyBoardGraphicWidget::on_num7Button_clicked()       //7
{
    int idx = lineEdit->cursorPosition();
    if(strContent.left(idx) == "0")
    {
...
void keyBoardGraphicWidget::on_num8Button_clicked()       //8
{
    int idx = lineEdit->cursorPosition();
    if(strContent.left(idx) == "0")
    {
...
void keyBoardGraphicWidget::on_num9Button_clicked()       //9
{
    int idx = lineEdit->cursorPosition();
    if(strContent.left(idx) == "0")
    {
...
void keyBoardGraphicWidget::on_dotButton_clicked()        //.
{
    int idx = lineEdit->cursorPosition();
...
void keyBoardGraphicWidget::on_num0Button_clicked()       //0
{
    int idx = lineEdit->cursorPosition();
...
void keyBoardGraphicWidget::on_signButton_clicked()       //+/-
{
    int idx = lineEdit->cursorPosition();
...
void keyBoardGraphicWidget::on_leftButton_clicked()       //left
{
    int idx = lineEdit->cursorPosition();
    if(idx == 0)
    {
...
void keyBoardGraphicWidget::on_rightButton_clicked()      //right
{
    int idx = lineEdit->cursorPosition();
...
void keyBoardGraphicWidget::on_backspaceButton_clicked()      //backspace
{
    int idx = lineEdit->cursorPosition();
    if(idx == 0)
    {
...
void keyBoardGraphicWidget::on_cancelButton_clicked()     //cancel
{
    this->close();
    valid = false;
}

void keyBoardGraphicWidget::on_okButton_clicked()         //ok
{
    this->close();
    valid = true;
}

void keyBoardGraphicWidget::setText(QString str)      //设置文本内容
{
    strContent = str;
    lineEdit->setText(strContent);
    lineEdit->setFocus();
...
QString keyBoardGraphicWidget::getText()              //获取内容
{
    return strContent;
}
