#ifndef KEYBOARDGRAPHICWIDGET_H
#define KEYBOARDGRAPHICWIDGET_H
...
class keyBoardGraphicWidget : public QGraphicsWidget
{
    Q_OBJECT

public:

    keyBoardGraphicWidget(QGraphicsWidget *parent = 0);
    ~keyBoardGraphicWidget();
    bool valid;
